...
I used several techniques and libraries to create the visualizations on this page. All visualizations used iterations of the final dataframe as the data source (for instance, I created several copies and trimmed only to include relevant columns). 
